...
var query = function (options, callback) {
  ...
  var startTime = new Date().getTime(); // Menyimpan waktu awal sebelum mengirim permintaan
  ...
  request.call(self, options, 'i', function (error, information) {
    ...
    request.call(self, options, 'r', function (error, rules) {
      ...
      if (response.online > 100) {
        response.players = [];
        var endTime = new Date().getTime(); // Menyimpan waktu setelah menerima respon
        response.ping = endTime - startTime; // Menghitung ping server
